...
export function BookingList() {
  const myBooking = useSelector(bookingSelector);
  ...
  const handleNewOldSelect = (e) => {
    ...
    setSelect(newSelect);
    dispatch(orderBookings(newSelect));
  };
  ...
  const handleOrderBySth = (e) => {
    ...
    dispatch(orderBookings(newOrderBySth));
  };
  ...
  useEffect(() => {
    ...
    setCurrentPage(1);
  }, [selectedFilter, myBooking.booking]);
